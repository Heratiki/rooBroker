...
class MenuSection:
    ...
    def __rich__(self) -> Panel:
        ...
        return Panel(
            Group(*menu_items), title="Menu", border_style="blue", box=box.ROUNDED
        )
...
class ModelsSection:
    ...
    def __rich__(self) -> Panel:
        ...
        visible_models = self.models[
            self.scroll_position : self.scroll_position + visible_lines
        ]
...
class PromptSection:
    ...
    def get_prompt_panel(self) -> Panel:
        ...
        return Panel(
            content, title="Prompt Improvement", border_style="blue", box=box.ROUNDED
        )
...
class InteractiveLayout:
    ...
    def _setup_layout(self):
        ...
        self.layout.split(
            Layout(name="menu"), Layout(name="content"), Layout(name="status")
        )
